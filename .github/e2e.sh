...
assert_log "RELAY_MODE keyframe" "relay detected the video stream and switches segments at keyframes"
assert_log "E2E_RELAY_STATUS .*\"bytesIn\":[1-9][0-9]*" "relay is receiving stream data"
assert_log "E2E_RELAY_STATUS .*\"mode\":\"keyframe\"" "relay reports keyframe segmentation in its status"
